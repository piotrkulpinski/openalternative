...
export const Banner = ({ className, ...props }: ComponentProps<typeof Container>) => {
  ...
  return (
    <Container
      className={cx(
        "group/button relative top-0 inset-x-0 z-50 flex items-center justify-between gap-3 bg-card border-b py-2 hover:bg-card-dark lg:border-x lg:rounded-b-lg",
        className,
      )}
      asChild
      {...props}
