...
export const inputVariants = cva({
  base: "rounded-lg border appearance-none px-3 py-2 text-[13px]/tight bg-background text-secondary resize-none [field-sizing:content] font-medium placeholder:text-inherit placeholder:opacity-50 disabled:opacity-50",
