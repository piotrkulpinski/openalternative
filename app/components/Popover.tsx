...
export const popoverVariants = cva({
  base: [
    "z-50 p-2 min-w-[8rem] rounded-md bg-background border shadow-md text-foreground text-xs outline-none shadow-[hsl(var(--color-foreground)/_20%)_0px_10px_38px_-10px,_hsl(var(--color-foreground)/_15%)_0px_10px_20px_-15px] will-change-[transform,opacity]",
